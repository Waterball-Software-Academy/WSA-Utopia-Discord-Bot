...
import tw.waterballsa.utopia.gamification.quest.domain.PeriodType.MAIN_QUEST
import tw.waterballsa.utopia.gamification.quest.domain.RoleType.EVERYONE
import tw.waterballsa.utopia.gamification.quest.domain.RoleType.WSA_MEMBER
import tw.waterballsa.utopia.gamification.quest.domain.actions.BooleanRule.TRUE
import tw.waterballsa.utopia.gamification.quest.domain.actions.ChannelIdRule.Companion.ANY_CHANNEL
import tw.waterballsa.utopia.gamification.quest.domain.quests.quest
import tw.waterballsa.utopia.gamification.quest.domain.quests.toRegexRule
import tw.waterballsa.utopia.gamification.quest.domain.EmptyPreCondition
import tw.waterballsa.utopia.gamification.quest.domain.Player
import tw.waterballsa.utopia.gamification.quest.domain.QuestIdPreCondition
import tw.waterballsa.utopia.gamification.quest.domain.Reward
import tw.waterballsa.utopia.gamification.quest.domain.actions.*
import tw.waterballsa.utopia.gamification.GenericTypedParameterResolver
